    			...
    			<div class="row">
						...
						<div class="col-sm-12 col-md-6">
							<div class="form-group">
								<div class="input-group input-group-sm input-daterange">
									<input type="text" class="form-control" id="date_from_lpj">
									<span class="input-group-addon">-</span>
									<input type="text" class="form-control" id="date_to_lpj">
					...
					<div class="row">
						<div class="col-sm-12 col-md-6 col-lg-6">
							...
							<div class="form-group">
								<select class="form-control select2" name="staff_lpj" id="staff_lpj">
						...
						<div class="col-sm-12 col-md-3">
							...
							<div class="form-group">
								<select class="form-control select2" name="status_lpj" id="status_lpj">
